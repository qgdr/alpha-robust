...
\begin{equation}
  \begin{aligned}
    ...
    &= \frac{d_{n,n}}{\Gamma(2-\gamma)} u(x, t_n) - \sum_{k=1}^{n-1} \frac{d_{n, k+1} - d_{n,k}}{\Gamma(2-\gamma)} u(x, t_{k}) - \frac{d_{n,1}}{\Gamma(2-\gamma)} u(x, t_0),
  \end{aligned}
\end{equation}
where
\begin{equation}
  d_{n,k} = \frac{(t_n-t_{k-1})^{1-\gamma} - (t_n-t_{k})^{1-\gamma}}{\tau_{k}}
  % \simeq (1-\gamma)(t_n-t_{k-1})^{-\gamma},
\end{equation}
$\quad d_{n,n} = \tau_n^{-\gamma}, \quad d_{n,k+1} \ge d_{n,k}$.
...
\begin{equation}
  \begin{aligned}
    \left(\frac{d_{n,n}}{\Gamma(2-\gamma)}I + A \right) E^n = \sum_{k=1}^{n-1} \frac{d_{n, k+1} - d_{n,k}}{\Gamma(2-\gamma)} E^{k} + \frac{d_{n,1}}{\Gamma(2-\gamma)} E^0 + R^{n}
  \end{aligned}
\end{equation}
